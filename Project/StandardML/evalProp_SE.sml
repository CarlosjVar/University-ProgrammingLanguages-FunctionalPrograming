...
(* type Identificador = string : pasamos esta declaraci�n al componente sintax.sml *)
...
fun evalProp asignacion prop =
  ...
  | negacion prop1
       => (* not (evalProp asignacion prop1) *)
          (* Es necesario poner par�ntesis alrededor del case, para que no se tome conjuncion (prop1, prop2) como parte del case *)
          (
